...
*Applicative* - контейнер, способный изменять свое значение с помощью функции,
обернутой в контейнер этого же типа. Он определяет несколько функций, но нам важна только одна:
